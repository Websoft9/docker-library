...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Strapi 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://hub.docker.com/r/strapi/strapi)）：
...
#### Strapi 运行后为什么打不开？  
Strapi 运行后会有一个5-10分钟的项目创建过程，需耐心等待  
### 使用说明
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| Strapi | 9001 | 浏览器访问 Strapi | Y |
## 文档

[Strapi 管理员手册](https://support.websoft9.com/docs/strapi)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Strapi 企业级支持版](https://apps.websoft9.com/strapi) 
