...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r strapi
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r strapi -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-strapi
cd docker-strapi
...
#### Why Strapi 500 error when the first time access it?  
I need 5-10 mins to install dependencies  
### Usage instructions
...
| --- | --- | --- | --- |
| Strapi | 9001 | HTTP to access Strapi | Y |
## Documentation

[Strapi Administrator Guide](https://support.websoft9.com/docs/strapi)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Strapi Enterprise Support](https://apps.websoft9.com/strapi) 
