...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r redis
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r redis -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-redis
cd docker-redis
...
| --- | --- | --- | --- |
| redis | 6379 | Accessing Redis database with TCP | Y |
## Documentation

[Redis Administrator Guide](https://support.websoft9.com/docs/redis)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Redis Enterprise Support](https://apps.websoft9.com/redis) 
