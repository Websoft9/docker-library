...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Tensorflow 复杂的安装及配置。
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| tensorboard | 6006 | 浏览器访问 tensorboard | Y |
| phpmyadmin | 9001 | jupyter | Y |
## 文档

[Tensorflow 管理员手册](https://support.websoft9.com/docs/tensorflow)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Tensorflow 企业级支持版](https://apps.websoft9.com/tensorflow) 
