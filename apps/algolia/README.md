...
The following are the minimal [recommended requirements](https://docsearch.algolia.com/docs/legacy/run-your-own):
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r algolia
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r algolia -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-algolia
cd docker-algolia
...
[Algolia Administrator Guide](https://support.websoft9.com/docs/algolia)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Algolia Enterprise Support](https://apps.websoft9.com/algolia) 
