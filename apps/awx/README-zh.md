...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 AWX 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://github.com/awx/docker#recommended-system-requirements)）：
...
修改 [docker-compose](docker-compose) 文件中冲突的端口，然后再启动容器
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| awx-server | 9002 | 浏览器访问 AWX | Y |
| phpmyadmin | 9090 | 数据库可视化管理工具 | Y |
## 文档

[AWX 管理员手册](https://support.websoft9.com/docs/awx)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [AWX 企业级支持版](https://apps.websoft9.com/awx) 
