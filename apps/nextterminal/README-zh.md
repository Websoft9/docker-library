...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Next Terminal 复杂的安装及配置。
...
[Next Terminal 管理员手册](https://support.websoft9.com/docs/nextterminal)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Next Terminal 企业级支持版](https://apps.websoft9.com/nextterminal) 
