...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nextterminal
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nextterminal -p
```
...
```
sudo bash install-nextterminal
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-nextterminal
cd docker-nextterminal
...
[Next Terminal Administrator Guide](https://support.websoft9.com/docs/nextterminal)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Next Terminal Enterprise Support](https://apps.websoft9.com/nextterminal) 
