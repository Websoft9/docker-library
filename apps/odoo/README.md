...
#### Can I set a persnal database name for Odoo?  
No, the name is must postgres  
### Usage instructions
...
| --- | --- | --- | --- |
| Odoo | 9001 | HTTP to access to odoo | Y |
| Postgres | 5432 | Postgres port | Y |
## Documentation

[Odoo Administrator Guide](https://support.websoft9.com/docs/odoo)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Odoo Enterprise Support](https://apps.websoft9.com/odoo) 
