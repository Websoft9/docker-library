...
1. In the [Websoft9](https://www.websoft9.com) console, open **My Apps** and select **Odoo**.
...
1. Make sure you are signed in to the Odoo admin console.
...
Websoft9 packages this app from the official [Odoo Docker image](https://hub.docker.com/_/odoo) and makes some improvements below.
