...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r vanish
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r vanish -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-vanish
cd docker-vanish
...
| --- | --- | --- | --- |
| vanish | 9091 | HTTP/HTTPS Proxy port | Y |
## Documentation

[Vanish  Administrator Guide](https://support.websoft9.com/docs/vanish)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Vanish  Enterprise Support](https://apps.websoft9.com/vanish) 
