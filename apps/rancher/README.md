...
1. In the [Websoft9](https://www.websoft9.com) console, open **My Apps** and select **Rancher**.
...
1. Make sure you are signed in to the Rancher admin console.
...
Websoft9 packages this app from the official [Rancher Docker image](https://hub.docker.com/r/rancher/rancher) and makes some improvements below.
...
Data is persisted in the `rancher` volume, mounted at `/var/lib/rancher`.
