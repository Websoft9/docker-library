...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CA or fuzzy match on create-app or new-app" exec="{project-root}/_bmad/bmb/workflows/app-curator/workflow-create-app.md">[CA] 创建新应用 - 从 GitHub Issue 开始完整流程</item>
